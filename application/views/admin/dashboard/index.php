...
<div class="flex-container dashboard-content">
        <div class="margin-content background-color screen-small min-left">
            ...
            <p class="font-dashboard"><?php echo getjumstatus(1);?> Orang</p>
            <p class="font-dashboard-black">Jumlah Penduduk</p>
        </div>
        <div class="margin-content1 background-color screen-small add-margin-top-dashboard min-left">
            ...
            <p class="font-dashboard"><?php echo getjumkk(1);?> KK</p>
            <p class="font-dashboard-black">Jumlah KK</p>    
        </div>
        <div class="margin-content1 background-color screen-small add-margin-top-dashboard min-left">
            <img src="<?php echo base_url('assets/images/dashboard/sad.png');?>" alt="" class="size-images">
            <p class="font-dashboard"><?php echo getjumstatus(2);?> Orang</p>
            <p class="font-dashboard-black">Jumlah Meninggal</p>    
        </div>
</div>
