...
<div class="panel panel-primary">
  ...
  <div class="form-group">
    ...
    <div class='col-md-9'><input type="date" name="tanggal" autocomplete="off" required placeholder="Masukkan Tanggal Lahir" class="form-control " ></div>
  </div>
  <br>
  <br>
  <div class="form-group">
  ...
  <br>
  <div class="form-group">
    <label class='col-md-3'>Foto (*jpeg,jpg)</label>
    <div class='col-md-9'><input type="file" name="gambar" accept="image/jpeg, image/png" autocomplete="off" class="form-control" ></div>
  </div>
  <br>
  <br>
  <div class="form-group">
