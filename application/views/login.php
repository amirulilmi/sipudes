...
<body>
	...
	<div style="position:absolute;width:100%;height:100%;box-sizing:border-box;">
		<h1 style="position:absolute;z-index:20;margin-left:60px;margin-top:25px;color:white;font-family:poppins"> PADRINGINSARI </h1>
		...
		<div class="tess" style="margin-left:40px;margin-top:70px;position:absolute;width:60%">
			<img width="100%" height="400px" style="" src="<?php echo base_url('assets/images/login/map.png'); ?>">
		</div>
	</div>
